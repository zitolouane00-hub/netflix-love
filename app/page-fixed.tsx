...
export default function NetflixLoveSite() {
  ...
  const playingItem = playingVideo ? allVideos.find(v => v.id === playingVideo) : null;

  // Affiche la grille complète des vidéos
  if (showAllThemes) {
    return (
      ...
      <div className="px-8 md:px-16 pt-10">
        ...
        <div className="flex gap-6 flex-wrap mb-14">
          {[
            ...
            <div key={index} className="cursor-pointer hover:scale-110 transition text-center">
              <img
                src={profile.img}
                alt={profile.name}
